    ...
    return Container(
      ...
      child: Scaffold(
        appBar: PreferredSize(
            preferredSize: Size(AppBar().preferredSize.height + 40,
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    borderRadius: const BorderRadius.all(Radius.circular(24.0)),
                    highlightColor:  FlutterFlowTheme.of(context).primaryColor,
                    focusColor: FlutterFlowTheme.of(context).primaryColor,
                    onTap: () {
